...
create index if not exists student_shifts_user_id_idx on public.student_shifts (user_id);
create index if not exists student_shifts_student_id_idx on public.student_shifts (student_id);
create index if not exists student_shifts_shift_date_idx on public.student_shifts (shift_date);
...
drop trigger if exists set_students_updated_at_trigger on public.students;
...
drop trigger if exists set_student_shifts_updated_at_trigger on public.student_shifts;
